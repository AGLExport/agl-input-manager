 ...
 * @brief	The listenet information for device udev.
 */
struct s_dynamic_device_udev_listener {
	device_udev_listener_handler_t func;		/**< The pointor to handler. */
	void *userdata;								/**< The pointor to user data.  */
};
...
struct s_dynamic_device_udev {
	...
	struct s_dynamic_device_udev_listener listener;	/** The listenet information. */
};
